...
class StudentFactory(factory.django.DjangoModelFactory):
    ...
    primary_day = 'tues'
    math_level = models.Student.LEVEL_CHOICES[random.randint(0, len(models.Student.LEVEL_CHOICES) - 1)][0]
    reading_level = models.Student.LEVEL_CHOICES[random.randint(0, len(models.Student.LEVEL_CHOICES) - 1)][0]
