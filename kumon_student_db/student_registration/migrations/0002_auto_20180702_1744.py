...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='student',
            name='how_choices',
            field=models.ManyToManyField(blank=True, to='student_registration.HowChoice'),
        ),
        migrations.AlterField(
            model_name='student',
        ...
        migrations.AlterField(
            model_name='student',
            name='why_choices',
            field=models.ManyToManyField(blank=True, to='student_registration.WhyChoice'),
        ),
    ]
