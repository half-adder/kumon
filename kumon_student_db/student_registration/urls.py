...
urlpatterns = [
    ...
    path("costs/registration_costs/create/", views.RegistrationCostCreateView.as_view(), name="registration-cost-add"),
    path("costs/monthly_costs/<int:pk>/", views.MonthlyCostUpdateView.as_view(), name="monthly-cost-update"),
    path("costs/registration_costs/<int:pk>/", views.RegistrationCostUpdateView.as_view(), name="registration-cost-update"),
    path("costs/monthly_costs/<int:pk>/delete", views.MonthlyCostDeleteView.as_view(), name="monthly-cost-delete"),
    path("costs/registration_costs/<int:pk>/delete", views.RegistrationCostDeleteView.as_view(), name="registration-cost-delete"),
    # API
